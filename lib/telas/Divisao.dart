...
class Divisao extends StatefulWidget {
  const Divisao({Key? key}) : super(key: key);
...
class _DivisaoState extends State<Divisao> {
  ...
  void _criarEquacao() {
    setState(() {
      _resposta.text = "";
      mensagemResposta = "";
      num1 = _random1.nextInt((_valorSlider.toInt()+1))+1;
      num2 = _random1.nextInt((_valorSlider.toInt()+1));
      while(num2 > num1 || num2 == 0 || num1 % num2 != 0 ){
        num2 = _random1.nextInt((_valorSlider.toInt()+1));
      }
    });
  }
  ...
  void _verificarResultado() {
    ...
    setState(() {
      ...
      if (int.parse(_resposta.text) == div) {
        mensagemResposta = "Correto";
      } else {
        mensagemResposta = "Nops! Resposta $div";
      }
    });
    print("Calculado");
  }
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    gradient: LinearGradient(
                        colors: [Color(0xffC62CC9), Color(0xff95F9C3)])),
                child: Container(
                  width: 600,
